...
You can retrieve the source as an array instead of a string by passing the `Array` type, to the `:to` option:

[,ruby]
----
puts Asciidoctor::Reducer.reduce_file 'sample.adoc', to: Array
----
